...
class ArtifactoryReader:
    ...
    def __init__(self, lib, model=None, artifactory_cfg=None):
        ...
        self.version_map = {"version": "", "build_num": "", "native": ""}
    ...
    def update_version_map(self, requested_version: str) -> None:
        self.initialize()
        parsed_data = {}
        if "master" in requested_version or "fbb" in requested_version or "native" in requested_version:
    ...
    def get_list_of_files(self, version: str, native: str) -> tuple:
        ...
        self.initialize()
        fw_list = []
        final_version = "native-" + version if native else version
    ...
    def build_list(self, requested_version: str) -> list:
        ...
        status, fw_list = self.get_list_of_files(self.version_map["version"], self.version_map["native"])
    ...
    def get_url_for_fw(self, version: str, **kwargs) -> str:
        ...
        if self.version_map["version"] and self.version_map["build_num"]:
            ...
            url = (
                ...
                f'{self.build_map[native + self.version_map["version"]]["proj-name"]}'
