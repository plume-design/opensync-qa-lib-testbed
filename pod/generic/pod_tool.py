...
class PodTool:
    ...
    def upgrade(self, image, *args, **kwargs):
        ...
        Upgrading from artifactory:
            Newest version:
                    pod <gw|l1|l2|all> upgrade <version|master> <optional>
                        eg.
                            pod gw upgrade master
                            pod all upgrade 4.2.0
            Requested build:
                    pod <gw|l1|l2|all> upgrade <version|master|fbb>-<build_num> <optional>
                        e.g.
    ...
    def set_region(self, region, **kwargs):
        """Set DFS regional domain (EU, US, UK, CA, JP) (for Caesar, also: NZ, SG, IL, HK)"""
    ...
    def trigger_radar(self, **kwargs):
        """Trigger radar event"""
        return self.lib.trigger_radar_detected_event(**kwargs)
    ...
    def get_wano_config(self, **kwargs):
        ...
        return self.lib.get_wano_cfg(**kwargs)
    ...
    def list_builds(self, requested_version):
        ...
        pod <gw|l1|l2|all> list-builds <version|master>
        eg.
    ...
    def is_fuse_burned(self):
        ...
        is_fuse = self.lib.is_fw_fuse_burned()
