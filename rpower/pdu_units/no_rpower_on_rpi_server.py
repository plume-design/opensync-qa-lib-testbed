...
class NoRpowerOnRpiServerLib(CommonPduLib):
    def __init__(self, server_object, rpower_devices, pod_names, client_names, address, user, password, port, tb_config,
                 **kwargs):
        super().__init__(server_object, rpower_devices, pod_names, client_names, address, user, password, port,
                         tb_config, **kwargs)
