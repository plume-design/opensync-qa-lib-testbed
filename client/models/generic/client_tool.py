...
class ClientTool:
    ...
    def info(self):
        ...
        if 'wlan' in info:
            for wlan, winfo in info['wlan'].items():
                ...
                info_txt += f' model: {self.lib.get_wlan_model()}\n'
                if 'driver' in winfo:
    ...
    def ep(self, command, **kwargs):
        ...
        return self.lib.run_command(f'{param_to}/wifi endpoint {command}', **kwargs)
    ...
    def ping_check(self, ipaddr='', count=1, fqdn_check=False, v6=False, **kwargs):
        ...
        (exit code 0)"""
        return self.lib.ping_check(count=count, fqdn_check=fqdn_check, v6=v6, ipaddr=ipaddr, **kwargs)
    ...
    def eth_connect(self, pod_or_port, ifname=None, dhclient=True,
        ...
        return self.lib.eth_connect(pod, port_alias=port_alias, ifname=ifname, dhclient=dhclient,
    ...
    def eth_disconnect(self, ifname=None, **kwargs):
        ...
        return self.lib.eth_disconnect(ifname, **kwargs)

    def connect(self, ssid=None, psk=None, ifname=None, bssid=None, key_mgmt=None, timeout=30, dhclient=True,
                country='US', ipv4=True, ipv6=False, ipv6_stateless=False, wps=False, eap=None, identity=None,
                password=None, global_params=None, net_params=None, node_name=None, node_band=None, **kwargs):
        ...
        def _get_bssid_from_node_name():
            ...
            for node in self.lib.config.get('Nodes'):
                ...
                break
            if not node_id:
                log.warning(f"Requested node name {node_name} not found in the testbed config,"
                            f" ignoring node name argument")
                return
        ...
        return self.lib.connect(ssid, psk, ifname=ifname, bssid=bssid, key_mgmt=key_mgmt, timeout=timeout,
                                ...
                                wps=wps, eap=eap, identity=identity, password=password, e_gl_param=e_gl_param,
                                e_net_param=e_net_param, **kwargs)
    ...
    def refresh_ip_address(self, iface=None, ipv4=True, ipv6=False, ipv6_stateless=False, timeout=10, reuse=False,
        ...
        ret = self.lib.refresh_ip_address(iface, ipv4, ipv6, ipv6_stateless, timeout, reuse, static_ip, clear_dhcp,
                                          **kwargs)
        if ret[0]:
            return ret
    ...
    def get_region(self, **kwargs):
        ...
        return self.lib.get_region(**kwargs)
    ...
    def start_simulate_client(self, device_to_simulate, ifname='', ssid=None, psk=None, bssid=None, fake_mac=None):
        ...
        return self.lib.start_simulate_client(device_to_simulate, ifname=ifname, ssid=ssid, psk=psk, bssid=bssid,
                                              fake_mac=fake_mac)
    ...
    def get_temperature(self, **kwargs):
        ...
        temp = self.lib.get_temperature(**kwargs)
