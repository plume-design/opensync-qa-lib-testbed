...
class SwitchToolGeneric:
    ...
    def recovery_switch_cfg(self, pod_name, force=False):
        """Set default configuration on switch for the provided <pod_names>=str. <force>=bool"""
        target_ports = self.switch_api.recovery_switch_configuration(pod_name, force=force)
