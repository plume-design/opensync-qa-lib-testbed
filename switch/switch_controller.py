...
class SwitchController:
    ...
    def init_switch_units(self, switch_unit_cfg):
        ...
        for switch_unit in switches_to_load:
            ...
            switch_lib = self.get_switch_lib(pdu_type=self.switch_type)(
    ...
    def execute_port_request(self, request: str, port_names: Union[str, list], **kwargs):
        ...
        for switch_unit in self.switch_units:
            ...
            switch_response = self.generate_port_request_output(
                switch_response=switch_response, port_names=list(switch_unit_ports.keys())
            )
    ...
    def set_forward_port_isolation(self, port_names: Union[str, list], forward_ports: str) -> dict:
        ...
        return self.execute_port_request(
            request="set_forward_port_isolation", port_names=port_names, forward_ports=forward_ports
        )
